...
class AW_Followupemail_Model_Cron
{
    ...
    public function cronJobs()
    {
        ...
        try {
            ...
            Mage::getModel('followupemail/visitorsemail')->flushProcessedQuotes($this->_lastExecTimeMySQL);
    ...
    protected function _checkAbandonedCarts()
    {
        ...
        $select = $read->select()
            ...
            ->joinLeft(
                array('v' => $resource->getTableName('followupemail/visitorsemail')),
                'q.entity_id=v.quote_id',
                array()
            )
            ->joinLeft(
                ...
                array(
                     'customer_email'      => new Zend_Db_Expr('IFNULL(IFNULL(q.customer_email, a.email), v.email)'),
            ...
            ->where('q.customer_email IS NOT NULL OR a.email IS NOT NULL OR v.email IS NOT NULL')
